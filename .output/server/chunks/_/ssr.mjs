...
function Header() {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "p-2 flex gap-2 bg-white text-black justify-between border-b", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "px-3 py-1 text-sm text-gray-500", children: "加载中..." }) : isAuthenticated ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
...
function UserInfo() {
  ...
  if (!userInfo) {
    return /* @__PURE__ */ jsx("div", { className: "px-2 text-sm text-gray-600", children: "用户" });
  }
