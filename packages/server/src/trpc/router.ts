    ...
    .query(() => ({
      ...
      endpoints: {
        notes: [
          ...
          'searchSemantic', 'searchFullText', 'searchVector',
          'createVersion', 'getVersions', 'getVersion', 'revertToVersion',
          'updatePosition', 'updateSize',
          'createConnection', 'getConnections', 'deleteConnection',
          'bulkCreate', 'bulkUpdate', 'bulkDelete',
          'getByTags', 'getRecent', 'getPopular', 'getSimilar',
          'recordActivity', 'getActivity',
          'export', 'import'
        ],
        users: [
          'create', 'getById', 'getByLogtoId', 'getByUsername', 'getByEmail', 'update', 'delete',
          'updateSettings', 'updatePreferences',
          'verifyEmail', 'updateLastLogin',
          'recordActivity', 'getActivity',
          'getStats', 'updateStorageUsage',
          'createInvite', 'getInvites', 'updateInviteStatus',
          'search', 'list', 'updateSubscription',
          'bulkUpdateSettings',
          'login', 'updateProfile', 'changePassword', 'resetPassword'
        ],
      },
    })),
});
