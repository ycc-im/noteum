...
import type { StorageEvent, StorageChangeEvent, StorageErrorEvent } from './events';
...
describe('StorageEventManager', () => {
  ...
  describe('Event Emission', () => {
    it('should emit events to registered listeners', () => {
      ...
      const event = StorageEventUtils.dataAdded('test-key', 'test-value', 'indexeddb');
    ...
    it('should not emit to unregistered event types', () => {
      ...
      const errorEvent = StorageEventUtils.operationError('Test error', 'test-op', 'indexeddb');
  ...
  describe('Event Filtering', () => {
    it('should filter events by source', () => {
      ...
      const indexeddbEvent = StorageEventUtils.dataAdded('test-key', 'test-value', 'indexeddb');
      const localstorageEvent = StorageEventUtils.dataAdded('test-key', 'test-value', 'localstorage');
    ...
    it('should filter change events by key pattern string', () => {
      ...
      const userEvent = StorageEventUtils.dataAdded('user.profile', 'data', 'indexeddb');
      const appEvent = StorageEventUtils.dataAdded('app.settings', 'data', 'indexeddb');
    ...
    it('should combine multiple filters', () => {
      ...
      const matchingEvent = StorageEventUtils.dataAdded('user.profile', 'data', 'indexeddb');
      const wrongSourceEvent = StorageEventUtils.dataAdded('user.profile', 'data', 'localstorage');
      const wrongKeyEvent = StorageEventUtils.dataAdded('app.settings', 'data', 'indexeddb');
  ...
  describe('Listener Removal', () => {
    ...
    it('should clean up debounce timers when removing listeners', () => {
      const unsubscribe = eventManager.on('change', mockListener, { debounce: 100 });
  ...
  describe('Event History', () => {
    ...
    it('should limit event history size', () => {
      ...
      for (let i = 0; i < 1005; i++) {
        const event = StorageEventUtils.dataAdded(`key-${i}`, 'value', 'indexeddb');
